  ...
  return through.obj(function(file, enc, cb) {
    ...
    if (file.isBuffer()) {
      if (/\.css$/.test(srcFile)) {
        ...
        fancyLog("Changed CSS file: \"" + srcFile + "\"");
      } else {
        if (/\.js$/.test(srcFile)) {
          //
          fancyLog("JS file not fully supported yet: \"" + srcFile + "\"");
        }
        try {
          ...
          fancyLog("Changed none-css file: \"" + srcFile + "\"");
        } catch (e) {
          // console.log(e);
          fancyLog("Catch error:" + e);
          fancyLog("File not changed: \"" + srcFile + "\"");
        }
      }
    }
    if (file.isStream()) {
